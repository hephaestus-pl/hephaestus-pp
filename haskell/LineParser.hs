...
happyReduction_9 (HappyTerminal (TokenText happy_var_1))
	 =  HappyAbsSyn5
		 (happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	EmptyLine -> cont 7;
	TokenCommentBegin -> cont 8;
	TokenCommentEnd -> cont 9;
	TokenPlasmaCutter -> cont 10;
	TokenText happy_dollar_dollar -> cont 11;
	_ -> happyError' (tk:tks)
	}
